...
#PBS -l select=32:ncpus=20:mpiprocs=20:mem=125gb:phase=15,walltime=03:00:00,place=scatter
...
#set bash variables
PPN=8
test_identifier="lg_ckpt_aggregation_profiling"
